package com.lcvl.gateway.routes;
...
public class Routes {
	...
	//http://localhost:8081/aggregate/order-service/v3/api-docs = http://localhost:8081/api-docs
	  @Bean
	...
	//http://localhost:8082/aggregate/inventory-service/v3/api-docs = http://localhost:8081/api-docs
	  @Bean
